      ...
      <div className="bg-black mt-4 flex items-center justify-between w-full px-4" style={{ paddingTop: 'env(safe-area-inset-top, 0)' }}>
        ...
        >
          ...
          <div 
            style={{
              marginLeft: '8px',
              display: 'inline-block',
              transform: 'rotate(-45deg) scale(1.472)',
              perspective: '1000px',
        ...
        <style>{`
          ...
          @keyframes applyBandaid {
            0% {
              transform: rotate(-45deg) scale(1.472) rotateZ(0deg) translateY(0px);
              opacity: 0;
              filter: drop-shadow(1px 1px 2px rgba(0,0,0,0.2));
            }
            30% {
              transform: rotate(-45deg) scale(1.96) rotateZ(-14deg) translateY(-4px);
              opacity: 1;
              filter: drop-shadow(4px 6px 8px rgba(0,0,0,0.4));
            }
            80% {
              transform: rotate(-45deg) scale(1.487) rotateZ(-0.3deg) translateY(-0.05px);
              opacity: 1;
