...
export function QuizCard({ 
  ...
  const getCategoryColors = (categoryIndex: number) => {
    ...
    const colorVars = {
      ...
      5: { bg: 'hsl(var(--quiz-category5-bg))', text: 'hsl(var(--quiz-category5-text))', pillBg: 'hsl(167 100% 45%)' }, // Magic Mint pill - neon
      6: { bg: 'hsl(var(--quiz-category6-bg))', text: 'hsl(var(--quiz-category6-text))', pillBg: 'hsl(56 90% 58%)' }, // Lemon Chiffon pill
      7: { bg: 'hsl(var(--quiz-category7-bg))', text: 'hsl(var(--quiz-category7-text))', pillBg: 'hsl(167 95% 48%)' }, // Magic Mint pill
