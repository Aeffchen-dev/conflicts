...
export function QuizCard({ 
  ...
  const getCategoryColors = (categoryIndex: number) => {
    ...
    const colorVars = {
      1: { bg: 'hsl(var(--quiz-category1-bg))', text: 'hsl(var(--quiz-category1-text))', pillBg: 'hsl(126 87% 65%)' }, // Lime Green pill
      2: { bg: 'hsl(var(--quiz-category2-bg))', text: 'hsl(var(--quiz-category2-text))', pillBg: 'hsl(311 64% 70%)' }, // Pink Lavender pill
      3: { bg: 'hsl(var(--quiz-category3-bg))', text: 'hsl(var(--quiz-category3-text))', pillBg: 'hsl(263 65% 70%)' }, // Lavender Blue pill
      4: { bg: 'hsl(var(--quiz-category4-bg))', text: 'hsl(var(--quiz-category4-text))', pillBg: 'hsl(27 88% 75%)' }, // Champagne Pink pill
      5: { bg: 'hsl(var(--quiz-category5-bg))', text: 'hsl(var(--quiz-category5-text))', pillBg: 'hsl(356 100% 80%)' }, // Baby Pink pill
      ...
      8: { bg: 'hsl(var(--quiz-category8-bg))', text: 'hsl(var(--quiz-category8-text))', pillBg: 'hsl(126 70% 68%)' }, // Lime variation pill
    };
