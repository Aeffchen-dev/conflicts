...
export function QuizCard({ 
  ...
  const getCategoryColors = (categoryIndex: number) => {
    ...
    const colorVars = {
      1: { bg: 'hsl(var(--quiz-category1-bg))', text: 'hsl(var(--quiz-category1-text))', pillBg: 'hsl(167 82% 60%)' }, // Magic Mint pill
      2: { bg: 'hsl(var(--quiz-category2-bg))', text: 'hsl(var(--quiz-category2-text))', pillBg: 'hsl(311 64% 70%)' }, // Pink Lavender pill
      3: { bg: 'hsl(var(--quiz-category3-bg))', text: 'hsl(var(--quiz-category3-text))', pillBg: 'hsl(126 87% 65%)' }, // Lime green pill
